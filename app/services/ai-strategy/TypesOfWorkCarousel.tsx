...
const workTypes = [
    ...
    },
    {
        ...
        description:
            'Design and implement AI agents that take autonomous action, such as customer service bots or intelligent automation systems that make decisions and execute tasks.',
        icon: (
            <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path
                    strokeLinecap="round"
                ...
                <div className="flex justify-center gap-2 mt-8">
                    {Array.from({ length: maxIndex + 1 }).map((_, index) => (
                        <button
                            ...
                            className={`w-3 h-3 rounded-full transition-all ${index === currentIndex ? 'bg-brand-accent w-8' : 'bg-gray-300 hover:bg-gray-400'
                                }`}
