...
const pillars = [
    {
        ...
        description:
            'Scattered spreadsheets. Legacy systems. Reports no one trusts. We help you build a modern data foundation so you can make decisions with confidence.',
    ...
    },
    {
        ...
        description:
            'We\'ve worked in AI for years, and we know what\'s real and what\'s noise. Whether you need a readiness assessment, a pilot, or a production-ready solution, we\'ll help you move from curiosity to value.',
