      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-3xl mx-auto space-y-4 text-lg text-white/90">
            <p>
              We don't just drop an app at your feet and walk away. We build intuitive solutions
              and bring your team along for the journey—so when we're done, you're not dependent
