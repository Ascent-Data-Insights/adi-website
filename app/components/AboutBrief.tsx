        ...
        <div className="text-center mb-12">
          ...
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
            <p>
              ...
              and AI expertise that big enterprises get—without the big enterprise price tag or
              attitude.
            </p>

            <p>
              We're based in Cincinnati, and we work with companies across Ohio, Kentucky, and
              Indiana. We're not here to sell you something you don't need. We're here to listen,
              understand your problem, and build the right solution.
            </p>
          </div>
        </div>
